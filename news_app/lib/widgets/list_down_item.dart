...
class ListDownItem extends StatelessWidget {
  ...
  final List<DownItemModel> items = const [
    ...
    DownItemModel(
      ...
      downTitl:
          r"Chelsea manager Enzo Maresca hit out at the Club World Cup organizers and suggested the United States is not a suitable host for the competition after his team’s last-16 win over Benfica was disrupted by a two-hour weather delay",
      img: "assets/che.avif",
    ),
    DownItemModel(
      topTitl:
          "Lionel Messi to face former team PSG in Club World Cup round of 16 after Inter Miami progresses from group stage",
      downTitl:
          r"Lionel Messi is set for a reunion with former team Paris Saint-Germain after Inter Miami drew 2-2 with Brazilian club Palmeiras to reach the Club World Cup round of 16. Goals from Tadeo Allende and Luis Suárez appeared to have earned Miami its second win of the group stage, but Paulinho and Maurício struck for Palmeiras inside the final 10 minutes to earn a vital draw that also sent the Verdão into the knockout stages.",
